...
export default async function KidWorkspacePage({ params }: PageProps) {
  ...
  if (error || !camperData) {
    if (process.env.NODE_ENV !== 'production' && !process.env.NEXT_PUBLIC_SUPABASE_URL) {
      camper = {
        ...
        name: id === "1" ? "John Smith" : id === "2" ? "Sarah Cohen" : id === "3" ? "David Levy" : "New Kid",
  ...
  return (
    <div className="min-h-screen bg-slate-50">
      ...
      <div className="container mx-auto py-8 px-4 max-w-6xl">
        ...
        {/* 8 Dedicated Kid Workspace Tabs */}
        <Tabs defaultValue="overview" className="w-full">
          <TabsList className="mb-6 flex flex-wrap justify-start h-auto bg-white p-1 rounded-lg border shadow-sm gap-1">
            ...
            <TabsTrigger value="vaad">VAAD Review</TabsTrigger>
          ...
          <TabsContent value="overview">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <div className="col-span-2 space-y-6">
                <Card>
                  <CardHeader>
                    <CardTitle>Kid Overview & Application Summary</CardTitle>
                  </CardHeader>
                ...
                <Card>
                  ...
                  <CardContent className="text-sm text-slate-600">
                    <p>Dynamic custom fields and metadata defined by administrators will be populated here.</p>
                  </CardContent>
                </Card>
              </div>
          ...
          <TabsContent value="chat">
            <Card>
              <CardHeader>
                <CardTitle>Shared Persistent Chat & Attribution</CardTitle>
              </CardHeader>
              <CardContent className="space-y-4">
                ...
                <div className="flex gap-2">
                  <input
                    type="text"
                    placeholder="Type a message or note (use @name to mention team members)..."
          ...
          <TabsContent value="documents">
            <Card>
              <CardHeader>
                <CardTitle>Documents & External Drive Storage</CardTitle>
              </CardHeader>
              <CardContent className="space-y-4">
                <div className="border-2 border-dashed border-slate-200 p-8 rounded-lg text-center bg-slate-50">
                  <p className="text-slate-600 mb-2">Upload application documents directly to Google Drive metadata store</p>
          ...
          <TabsContent value="photos">
            <Card>
              ...
              <CardContent className="p-8 text-center text-slate-500">
                Uploaded pictures and gallery items with captions will appear here.
              </CardContent>
            </Card>
          </TabsContent>
          ...
          <TabsContent value="voice-notes">
            <Card>
              ...
              <CardContent className="p-8 text-center text-slate-500">
                Audio recordings, duration metadata, and transcription logs will appear here.
              </CardContent>
            </Card>
          </TabsContent>
          ...
          <TabsContent value="transcript">
            <Card>
              ...
              <CardContent className="p-8 text-center text-slate-500">
                School report cards and official transcript files will appear here.
              </CardContent>
            </Card>
          </TabsContent>
          ...
          <TabsContent value="vaad">
            <Card>
              <CardHeader className="flex flex-row items-center justify-between">
                <CardTitle>VAAD Review & Voting</CardTitle>
          ...
          <TabsContent value="activity">
            <Card>
              ...
              <CardContent className="space-y-3">
                ...
                <div className="text-xs text-slate-600 border-b pb-2">
                  <span className="font-semibold">Kid Record Created</span> (App #{camper.application_number}) — {new Date(camper.created_at).toLocaleDateString()}
                </div>
              </CardContent>
            </Card>
          </TabsContent>
