...
export default function LoginPage() {
  ...
  const handleOAuthSignIn = async (provider: 'google' | 'github', withDrive = false) => {
    const key = withDrive ? 'google-drive' : provider
        ...
        <Card className="shadow-md border-slate-200">
          ...
          <CardContent className="space-y-4">
            ...
            <div className="space-y-3">
              {/* Google OAuth with Drive Read/Write/Store Access */}
              <Button
                variant="default"
                type="button"
                className="w-full h-12 flex items-center justify-center gap-3 text-sm font-medium bg-blue-600 hover:bg-blue-700 text-white transition-colors shadow-sm"
              ...
              <Button
                variant="outline"
                type="button"
                className="w-full h-11 flex items-center justify-center gap-3 text-sm font-medium border-slate-300 hover:bg-slate-50 transition-colors shadow-sm"
            ...
            <div className="p-3 bg-slate-50 border rounded-lg text-xs text-slate-500 space-y-1">
              <div className="font-semibold text-slate-700">Google Drive Access Note:</div>
              <p>
                Signing in with Google Drive access requests OAuth 2.0 read, write, and store permissions to upload, manage, and archive admissions documents, photos, voice notes, and contracts.
              </p>
            </div>
          </CardContent>
          <CardFooter className="justify-center border-t pt-4">
            <Link href="/help" className="text-xs text-slate-500 hover:text-slate-800">
              Need technical support or access credentials? View User Guide
            </Link>
          </CardFooter>
        </Card>
      </div>
